...
public:
    ...
    double getvelocity(double theta1dot, double theta2dot, double theta3dot, 
        double theta4dot, double theta5dot, double theta6dot, double IMUthetadot);
    ...
    double getyawvelocity(double theta1dot, double theta2dot, double theta3dot,
        double theta4dot, double theta5dot, double theta6dot, double IMUthetadot);
...
double WheeledBiped::getvelocity(double theta1dot, double theta2dot, double theta3dot,
    double theta4dot, double theta5dot, double theta6dot, double IMUthetadot)
{ 
    if(theta3dot + theta2dot + theta1dot> theta4dot + theta5dot + theta6dot){
         return (theta3dot + theta2dot + theta1dot + IMUthetadot)* WheeledBiped::R;
    }
    else
    {
        return (theta4dot + theta5dot + theta6dot + IMUthetadot) * WheeledBiped::R;
    }
}
...
double WheeledBiped::getyawvelocity(double theta1dot, double theta2dot, double theta3dot,
    double theta4dot, double theta5dot, double theta6dot, double IMUthetadot)
{
    if (theta3dot + theta2dot + theta1dot > theta4dot + theta5dot + theta6dot) {
        return (theta3dot + theta2dot + theta1dot + IMUthetadot) * WheeledBiped::R / 0.41;
    }
    else
    {
        return (theta4dot + theta5dot + theta6dot + IMUthetadot) * WheeledBiped::R / 0.41; //rad/s
    }
}
